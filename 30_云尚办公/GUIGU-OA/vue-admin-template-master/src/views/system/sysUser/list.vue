    ...
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column label="所属角色" width="130">
                <template slot-scope="scope">
                    <span v-for="item in scope.row.roleList" :key="item.id" style="margin-right: 10px;">{{
                            item.roleName
                        }}</span>
                </template>
            </el-table-column>
...
import { getRoles, assignRoles } from '@/api/system/sysRole'
...
export default {
    ...
    methods: {
        ...
        getRoles() {
            getRoles(this.sysUser.id).then(response => {
                const { allRoleList: allRoleList, assignRoleList: assignRoleList } = response.data
        ...
        */
        ...
        assignRole() {
            ...
            assignRoles(assignRoleVo).then(response => {
